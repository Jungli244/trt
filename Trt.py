      ...
      _\/\\\_______\/\\\____\/\\\____\/\\\_  
       _\/\\\_______\/\\\__/\\\\\\\\\_\/\\\_ 
        _\///________\///__\/////////__\///__
                         ALI RAZA SYAL
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;94m•\x1b[1;92m•\x1b[1;97m] Author   : ALI RAZA SYAL
     ...
     _\/\\\/////////\\\____\/\\\____\/\\\_   
      _\/\\\_______\/\\\____\/\\\____\/\\\_  
       _\/\\\_______\/\\\__/\\\\\\\\\_\/\\\_ 
        ...
        ALI RAZA SYAL
\x1b[1;94m────────────────────────────────────────────────────
\x1b[1;97m [\x1b[1;92m+\x1b[1;97m] Author   : ALI RAZA SYAL
...
def moch_yayan():
    time.sleep(0.1)
    print("\033[97m [\033[96m01\033[97m] Start Crake ID with ALI RAZA SYAL")
    ...
    if yayan == "1" or yayan == "01":
        ...
        if __name__ == '__main__':
            try:
                ...
                jembut()
                print(
                    '\n\x1b[1;96m        ∆∆∆_______Ali raza HAT ᴴᴬᶜᴷᴱᴿ 𝙸𝚖. _______∆∆∆')
                print('\x1b[1;95m     疊╔═╦═────••♽••─────═╦═╗疊')
                print('\x1b[1;97m           Total ID\x1b[1;91m :\x1b[1;92
                    len(id)) + "\n\x1b[1;95m     疊╚═╩═────••♽••─────═╩═╝疊\n", end="")
                ...
                jembut()
                print(
                    '\n\x1b[1;92m        ∆∆∆_______ALI RAZA SYAL ♥️ . _______∆∆∆')
                print('\x1b[1;97m     疊╔═╦═────••♽••─────═╦═╗疊')
